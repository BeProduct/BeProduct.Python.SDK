...
class TestAttributesMixin(unittest.TestCase):
    ...
    def test_folders(self):
        ...
        self.assertTrue(
            *test_helpers.is_subset_or_equals(self.config.STYLE_FOLDER, test_folder)
        )
    ...
    def test_attributes_list(self):
        ...
        self.assertTrue(
            *test_helpers.is_subset_or_equals(self.config.STYLE, next(fields_filtered))
        )
    ...
    def test_attributes_get(self):
        ...
        self.assertTrue(
            *test_helpers.is_subset_or_equals(
                self.config.STYLE,
                self.client.style.attributes_get(header_id=self.config.STYLE["id"]),
            )
        )
