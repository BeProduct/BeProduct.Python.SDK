"""
File: _common_upload_async.py
Author: Yuri Golub
Email: yuri.golub@beproduct.com
Github: https://github.com/BeProduct
Description: Common Upload Mixin - Async Version
"""

from ._exception import BeProductException
from .sdk_async import BeProductAsync

class UploadMixinAsync:
    """
    Common upload methods for any master folder (Style, Material, etc.) - Async Version
    """

    def __init__(self, master_folder, client: BeProductAsync):
        self.master_folder = master_folder
        self.client = client

    async def attributes_upload(self,
                          header_id: str,
                          filepath: str = None,
                          fileurl: str = None,
                          position: str = None):
        """ Uploads file to Attributes asynchronously
    ...
    async def app_list_upload(self,
                        header_id: str,
                        app_id: str,
                        list_item_id: str,
                        filepath: str = None,
                        fileurl: str = None):
        """ Uploads image to List/List-Form/List-Grid apps asynchronously
    ...
    async def app_attachments_upload(
            self,
            header_id: str,
            app_id: str,
            filepath: str = None,
            fileurl: str = None):
        """ Uploads image to Attachment app asynchronously
    ...
    async def app_imageform_upload(
            self,
            header_id: str,
            app_id: str,
            filepath: str = None,
            fileurl: str = None):
        """Uploads image in ImageForm application asynchronously
    ...
    async def app_imagegrid_upload(
            self,
            header_id: str,
            app_id: str,
            filepath: str = None,
            fileurl: str = None):
        """Uploads image in ImageGrid application asynchronously
        ...
        return await self.app_imageform_upload(
            header_id=header_id,
            app_id=app_id,
            filepath=filepath,
            fileurl=fileurl)

    async def upload_status(self, upload_id: str):
        """ Checks upload status asynchronously

        :returns: Tuple (is_finished, is_error, error_msg)
        """
        return await self.client.raw_api.upload_status(upload_id) 